...
#define PIDTEMP
#define BANG_MAX 255 // "200"limits current to nozzle while in bang-bang mode; 255=full current
#define PID_MAX 255 // "200"limits current to nozzle while PID is active (see PID_FUNCTIONAL_RANGE below); 255=full current
#ifdef PIDTEMP
...
#define DEFAULT_XYJERK                5.0    // (mm/sec)20
#define DEFAULT_ZJERK                 0.2     // (mm/sec)0.4
#define DEFAULT_EJERK                 2.0    // (mm/sec)5
